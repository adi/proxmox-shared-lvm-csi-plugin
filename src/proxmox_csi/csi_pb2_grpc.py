...
class ControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSnapshot = channel.unary_unary(
                '/csi.v1.Controller/GetSnapshot',
                request_serializer=csi__pb2.GetSnapshotRequest.SerializeToString,
                response_deserializer=csi__pb2.GetSnapshotResponse.FromString,
                _registered_method=True)
...
def add_ControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetSnapshot': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=csi__pb2.GetSnapshotRequest.FromString,
                    response_serializer=csi__pb2.GetSnapshotResponse.SerializeToString,
            ),
...
class Controller(object):
    ...
    def GetSnapshot(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/csi.v1.Controller/GetSnapshot',
            csi__pb2.GetSnapshotRequest.SerializeToString,
            csi__pb2.GetSnapshotResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
